    ...
    return (
        ...
        <>
            ...
            <div className="body_container">
                <div className="baby_container1">
                    <div className="wrapper" >
                        ...
                        <ul className="carousel" ref={containerRef1}>
                            <li className="card">
                                <div className="img"><a href="https://www.amazon.in/"><img src={logo11} alt="img" draggable="false" /></a></div>

                            </li>
                            <li className="card">
                                <div className="img">
                                    <a href="https://www.amazon.in/"><img src={logo1}
                                        alt="img" draggable="false" /></a></div>

                            </li>
                            <li className="card">
                                <div className="img"><a href="https://www.myntra.com/">
                                    <img src={logo2} alt="img"
                                        draggable="false" /></a></div>

                            </li>
                            <li className="card">https://www.dotandkey.com/
                                <div className="img"><a href='https://www.dotandkey.com/'><img src={logo3} alt="img"
                                    draggable="false" /></a></div>

                            </li>
                            <li className="card">
                                <div className="img"><a href="https://www.amazon.in/">
                            ...
                            <li className="card">
                                <div className="img"><a href="https://www.amazon.in/"><img src={logo5} alt="img"
                                    draggable="false" /></a></div>

                            </li>
                            <li className="card">
                                <div className="img"><a href="https://aqualogica.in/"><img src={logo6} alt="img"
                                    draggable="false" /></a></div>

                            </li>
                            <li className="card">
                                <div className="img"><a href="https://www.ajio.com/"><img src={logo7} alt="img"
                                    draggable="false" /></a></div>

                            </li>
                            <li className="card">
                                <div className="img"><a href="https://mamaearth.in/"><img src={logo8} alt="img"
                                    draggable="false" /></a></div>

                            </li>
                            <li className="card">
                                <div className="img"><a href="https://www.amazon.in/"><img src={logo9}
                                    alt="img" draggable="false" /></a></div>
                    ...
                    <div className="wrapper2" id="wrapper2">
                        ...
                        <ul className="carousel2" id="carousel2" ref={containerRef2}>
                            ...
                            <li className="card2" id="card1">
                                <div className="img2"> <a href="https://www.amazon.in/"><img src={logo14} alt="hi"
                                    draggable="false" /></a></div>

                            </li>
                            <li className="card2" id="card2">
                                <div className="img"> <a href="https://www.amazon.in/"><img src={logo15} alt="img"
                                    draggable="false" /></a></div>

                            </li>
                            <li className="card2" id="card3">
                                <div className="img2"> <a href="https://www.amazon.in/"><img src={logo16} alt="img"
                                    draggable="false" /></a></div>
                            </li>
                            <li className="card2" id="card4">
                                <div className="img2"> <a href="https://www.amazon.in/"><img src={logo17}
                                    alt="img" draggable="false" /></a></div>

                            </li>CupponPage1
                            <li className="card2" id="card5">
                                <div className="img2"> <a href="https://www.amazon.in/"><img src={logo18}
                                    alt="img" draggable="false" /></a></div>

                            </li>
                            <li className="card2" id="card6">
                                <div className="img2"> <a href="https://www.amazon.in/"><img src={logo19}
                                    alt="img" draggable="false" /></a></div>

                            </li>
                            <li className="card2" id="card7">
                                <div className="img2"> <a href="https://www.amazon.in/"><img src={logo20} alt="img"
                                    draggable="false" /></a></div>

                            </li>
                            <li className="card2" id="card8">
                                <div className="img2"> <a href="https://www.amazon.in/"><img src={logo21} alt="img"
                                    draggable="false" /></a></div>
                            ...
                            <li className="card3">
                                <div className="card3_1">
                                    <div className="img3"><img src={logo22} alt="img"
                                        draggable="false" /></div>
                                    <div className="img3-bt"><a href="https://www.acer.com/in-en">EARN UPTO 45% CASHBACK NOW</a></div>
                                    <a href="">Cashback Rates & Terms</a>
                                </div>
                                <div className="card3_2">
                                    <div className="img3"><img src={logo23} alt="img"
                                        draggable="false" /></div>
                                    <div className="img3-bt"><a href="https://www.adidas.co.in/">EARN UPTO 45% CASHBACK NOW</a></div>
                                    <a href="">Cashback Rates & Terms</a>
                                </div>
                            </li>
                            <li className="card3">
                                <div className="card3_1">
                                    ...
                                    <div className="img3-bt"><a href="https://www.ajio.in/">EARN UPTO 16% CASHBACK NOW</a></div>
                                    <a href="">Cashback Rates & Terms</a>
                                </div>
                                <div className="card3_2">
                                    <div className="img3"><img src={logo25} alt="img"
                                        draggable="false" /></div>
                                    <div className="img3-bt"><a href="https://www.amazon.in/">EARN UPTO 16% CASHBACK NOW</a></div>
                                    <a href="">Cashback Rates & Terms</a>
                                </div>
                            </li>
                            <li className="card3">
                                <div className="card3_1">
                                    <div className="img3"><img src={logo26} alt="img"
                                        draggable="false" /></div>
                                    <div className="img3-bt"><a href=" https://www.apple.com/">EARN UPTO 6% CASHBACK NOW</a></div>
                                    <a href="">Cashback Rates & Terms</a>
                                </div>
                                <div className="card3_2">
                                    <div className="img3"><img src={logo27} alt="img"
                                        draggable="false" /></div>
                                    <div className="img3-bt"><a href="https://www.dotandkey.com/">EARN UPTO 6% CASHBACK NOW</a></div>
                                    <a href="">Cashback Rates & Terms</a>
                                </div>
                            </li>
                            <li className="card3">
                                <div className="card3_1">
                                    ...
                                    <div className="img3-bt"><a href="https://www.flipkart.com/">EARN UPTO 11% CASHBACK NOW</a></div>
                                    <a href="">Cashback Rates & Terms</a>
                                </div>
                                <div className="card3_2">
                                    <div className="img3"><img src={logo29}
                                        alt="img" draggable="false" /></div>
                                    <div className="img3-bt"><a href="https://mamaearth.in/">EARN UPTO 11% CASHBACK NOW</a></div>
                                    <a href="">Cashback Rates & Terms</a>
                                </div>
                            </li>
                            <li className="card3">
                                <div className="card3_1">
                                    <div className="img3"><img src={logo30} alt="img"
                                        draggable="false" /></div>
                                    <div className="img3-bt"><a href="https://www.muscleblaze.com/"> EARN UPTO 35% CASHBACK NOW</a></div>
                                    <a href="">Cashback Rates & Terms</a>
                                </div>
                                <div className="card3_2">
                                    <div className="img3"><img src={logo31} alt="img" draggable="false" /></div>
                                    <div className="img3-bt"><a href="https://zanducare.com/"> EARN UPTO 35% CASHBACK NOW</a></div>
                                    <a href="">Cashback Rates & Terms</a>
                                </div>
                            </li>
                            <li className="card3">
                                <div className="card3_1">
                                    <div className="img3"><img src={logo32} alt="img"
                                        draggable="false" /></div>
                                    <div className="img3-bt"><a href="https://flipkart.com/">EARN UPTO 35%CASHBACK NOW</a></div>
                                    <a href="">Cashback Rates & Terms</a>
                                </div>
                                <div className="card3_2">
                                    <div className="img3"><img src={logo33} alt="img"
                                        draggable="false" /></div>
                                    <div className="img3-bt"><a href="https://mamaearth.in/">EARN UPTO 35%CASHBACK NOW</a></div>
                                    <a href="">Cashback Rates & Terms</a>
                                </div>
                            </li>
                            <li className="card3">
                                <div className="card3_1">
                                    ...
                                    <div className="img3-bt"><a href="">
                                        <a href="https://www.muscleblaze.com/">EARN UPTO 9% CASHBACK NOW</a>
                                    </a></div>
                                    <a href="">Cashback Rates & Terms</a>
                                </div>
                                <div className="card3_2">
                                    ...
                                    <div className="img3-bt"><a href="">
                                        <a href="https://zanducare.com/">EARN UPTO 9% CASHBACK NOW</a>
                                    </a></div>
                                    <a href="">Cashback Rates & Terms</a>
                                </div>
                            </li>
                            <li className="card3">
                                <div className="card3_1">
                                    <div className="img3"><img src={logo36} alt="img"
                                        draggable="false" /></div>
                                    <div className="img3-bt"><a href="https://aqualogica.in/">EARN UPTO 5% CASHBACK NOW</a></div>
                                    <a href="">Cashback Rates & Terms</a>
                                </div>
                                <div className="card3_2">
                                    <div className="img3"><img src={logo37} alt="img"
                                        draggable="false" /></div>
                                    <div className="img3-bt"><a href="https://world.benetton.com/">EARN UPTO 5% CASHBACK NOW</a></div>
                                    <a href="">Cashback Rates & Terms</a>
                                </div>
                            </li>
                            <li className="card3">
                                <div className="card3_1">
                                    <div className="img3"><img src={logo38} alt="img"
                                        draggable="false" /></div>
                                    <div className="img3-bt"><a href="https://bira91.com/">EARN UPTO 25% CASHBACK NOW</a></div>
                                    <a href="">Cashback Rates & Terms</a>
                                </div>
                                <div className="card3_2">
                                    <div className="img3"><img src={logo39} alt="img"
                                        draggable="false" /></div>
                                    <div className="img3-bt"><a href="https://www.bombayshavingcompany.com/">EARN UPTO 25% CASHBACK NOW</a></div>
                                    <a href="">Cashback Rates & Terms</a>
                                </div>
                            </li>
                            <li className="card3">
                                <div className="card3_1">
                                    <div className="img3"><img src={logo40} alt="img"
                                        draggable="false" /></div>
                                    <div className="img3-bt"><a href="https://bookkaru.com/">EARN UPTO 8% CASHBACK NOW</a></div>
                                    <a href="">Cashback Rates & Terms</a>
                                </div>
                                <div className="card3_2">
                                    <div className="img3"><img src={logo41} alt="img"
                                        draggable="false" /></div>
                                    <div className="img3-bt"><a href="https://buykaro.com/">EARN UPTO 8% CASHBACK NOW</a></div>
                                    <a href="">Cashback Rates & Terms</a>
                                </div>
                            </li>
                        </ul>
                        ...
                        <ul className="carousel4" id="carousel4" ref={containerRef4}>
                            <li className="card4" id="card4">
                                ...
                                <div className="cardclick">
                                   <a href='https://buykaro.com/'> <button>Grab Deal</button></a>
                                </div>
                            </li>
                            <li className="card4" id="card4">
                                <div className="img4"><img src={logo37} alt="" /><img
                        ...
                        <ul className="carousel5" id="carousel5" ref={containerRef5}>
                            <li className="card5">
                                <div className="img5"><img src={logo49} alt="img"
                                    draggable="false" /></div>
                                <div className="cardclick">
                                   <a href='https://www.dotandkey.com/collections'> <button>Grab Deal</button></a>
                                </div>
                            </li>
                            <li className="card5">
                ...
                <div className="definer">
                    <a href="https://www.muscleblaze.com/">Best Food & Grocery</a>
                    <a href="">View All-</a>
                </div>
                        ...
                        <ul className="carousel6" id="carousel6" ref={containerRef6}>
                            <li className="card6">
                                <div className="img6"><img src={logo51} alt="img"
                                    draggable="false" /></div>
                                <div className="cardclick">
                                   <a href='https://www.zomato.com/'> <button>Grab Deal</button></a>
                                </div>
                            </li>
                            <li className="card6">
                ...
                <div className="definer">
                    <a href="https://www.muscleblaze.com/">Best in beauty</a>
                    <a href="">View All-</a>
                </div>
                    ...
                    <div className="wrapper7" id="wrapper6">
                        ...
                        <ul className="carousel7" id="carousel7" ref={containerRef7}>
                            <li className="card7">
                                ...
                                <div className="cardclick">
                                   <a href='https://www.dotandkey.com/'> <button>Grab Deal</button></a>
                                </div>
                            </li>
                            <li className="card7">
                                ...
                                <div className="cardclick">
                                   <a href='https://mamaearth.in/'> <button>Grab Deal</button></a>
                                </div>
                            </li>
                            <li className="card7">
                ...
                <div className="definer">
                    <a href="https://www.muscleblaze.com/">Best In Travel</a>
                    <a href="">View All-</a>
                </div>
                        ...
                        <ul className="carousel8" id="carousel8" ref={containerRef8}>
                            <li className="card8">
                                <div className="img8"><img src={logo65} alt="img"
                                    draggable="false" /></div>
                                <div className="cardclick">
                                   <a href='https://www.makemytrip.com/'> <button>Grab Deal</button></a>
                                </div>
                            </li>
                            <li className=" card8">
                ...
                <div className="definer">
                    <a href="">Top selling Product Live Now !</a>
                    <a href="">View All-</a>
                </div>
                <div className="baby_container9">
                    <div className="wrapper9" id="wrapper9">
                        ...
                        <ul className="carousel9" id="carousel9" ref={containerRef9}>
                            <li className="card9">
                                <a href="https://www.muscleblaze.com/">Price Compared (3 Sellers)</a>
                                <div className="img9"><img src={logo66} alt="img" draggable="false" /></div>
                                <a href="https://www.muscleblaze.com/">Brand:<span>Optimum nutrition</span></a>

                                <div className="cardclick">
                                    <i><span>&#8377;1399 </span>&#8377;699(36% off)</i>

                                     <a href="https://www.muscleblaze.com/"><button>+122 cashback</button></a>
                                </div>
                                <a href="">Final Price &#8377;645</a>
                            </li>
                            <li className=" card9">
                                <a href="https://www.muscleblaze.com/">Price Compared (2 Sellers)</a>
                                <div className="img9"><img src={logo67} alt="img" draggable="false" /></div>
                                <a href="https://www.muscleblaze.com/">Brand:<span>Muscle Blaze</span></a>

                                <div className="cardclick">
                                    <i><span>&#8377;1399 </span>&#8377;899(36% off)</i>
                                     <a href="https://www.muscleblaze.com/"><button>+&#8377;144 Cashback</button></a>
                                </div>
                                <a href="">Final Price &#8377;755</a>

                            </li>
                            <li className="card9">
                                <a href="https://www.muscleblaze.com/">Price Compared (5 Sellers)</a>
                                <div className="img9"><img src={logo68} alt="img" draggable="false" /></div>
                                <a href="https://www.muscleblaze.com/">Brand:<span>Optimum nutrition</span></a>
                                <div className="cardclick">
                                    <span>&#8377;1719 <i>&#8377;9499</i><i>(45% off)</i></span>
                                     <a href="https://www.muscleblaze.com/"><button>+&#8377;152 Cashback</button></a>
                                </div>
                            ...
                            <li className=" card9">
                                ...
                                <div className="cardclick">
                                    <span>&#8377;1390<i>&#8377;1190</i><i>(6% off)</i></span>
                                     <a href="https://www.muscleblaze.com/"><button>+&#8377;190 Cashback</button></a>
                                </div>
                            ...
                            <li className=" card9">
                                ...
                                <a href="https://www.muscleblaze.com/">Brand:<span>GNC</span></a>

                                <div className="cardclick">
                                    <span>&#8377;5499 <i>&#8377;2999</i><i>(45% off)</i></span>
                                     <a href="https://www.muscleblaze.com/"><button>+&#8377;480 Cashback</button></a>
                                </div>
                            ...
                            <li className=" card9">
                                ...
                                <a href="https://www.muscleblaze.com/">Brand:<span>Bolt</span></a>

                                <div className="cardclick">
                                    <span>&#8377;999 <i>&#8377;899</i><i>(36% off)</i></span>
                                     <a href="https://www.muscleblaze.com/"><button>+&#8377;160 Cashback</button></a>
                                </div>
                                <a href="">Final Price &#8377;839</a>
                            </li>
                            <li className=" card9">
                                <a href="https://www.muscleblaze.com/">Price Compared (4 Sellers)</a>
                                <div className="img9"><img src={logo72} alt="img" draggable="false" /></div>
                                <a href="https://www.muscleblaze.com/">Brand:<span>Optimum nutrition</span></a>

                                <div className="cardclick">
                                    <span>&#8377;299 <i>&#8377;199</i><i>(33% off)</i></span>
                                     <a href="https://www.muscleblaze.com/"><button>+&#8377;50 Cashback</button></a>
                                </div>
                            ...
                            <li className=" card9">
                                ...
                                <a href="https://www.muscleblaze.com/">Brand:<span>YogaBar</span></a>
                    ...
                    <div className="wrapper10" id="wrapper10">
                        ...
                        <ul className="carousel10" id="carousel10" ref={containerRef10}>
                            ...
                            <li className="card10">
                                ...
                                <div className="h10">
                                    <h1>What is Rewardify Cuppons?</h1>
                                    <p>When you visit any online site, such as Amazon or Myntra, by clicking through Rewardify
